...
export const ui = {
  en: {
    ...
    'projects.videoFallback': 'Mobile browsers can block embedded playback. Open video safely on YouTube.',
    'projects.watchOnYoutube': 'Watch on YouTube',
  ...
  es: {
    ...
    'projects.videoFallback': 'Algunos navegadores m\u00f3viles bloquean el reproductor embebido. Abre el video de forma segura en YouTube.',
    'projects.watchOnYoutube': 'Ver en YouTube',
